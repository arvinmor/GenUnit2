package GenUnit_v2
  package Partial_models
    partial model Generator
      ...
      Modelica.Blocks.Interfaces.RealInput u annotation(Placement(visible = true, transformation(origin = {-80, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 100}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  package Architecture
    partial model Gen_Ex_Tg
      ...
      replaceable GenUnit_v2.Partial_models.TurbineGovernor turbinegovernor annotation(Placement(visible = true, transformation(origin = {-40, -30}, extent = {{-25, -25}, {25, 25}}, rotation = 0)));
    equation
      connect(turbinegovernor.SPEED, generator.ETERM) annotation(Line(points = {{-65, -10}, {-75.0617, -10}, {-75.0617, -67.6543}, {78.2716, -67.6543}, {78.2716, 0.740741}, {64.6914, 0.740741}, {64.6914, 0.740741}}, color = {0, 0, 127}));
      connect(turbinegovernor.PMECH0, generator.PMECH0) annotation(Line(points = {{-15, -50}, {-1.48148, -50}, {-1.48148, -19.7531}, {14.321, -19.7531}, {14.321, -19.7531}}, color = {0, 0, 127}));
      connect(turbinegovernor.PMECH, generator.PMECH) annotation(Line(points = {{-15, -45}, {-3.95062, -45}, {-3.95062, -15.0617}, {13.0864, -15.0617}, {13.0864, -15.0617}}, color = {0, 0, 127}));
